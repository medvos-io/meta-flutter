...
PACKAGECONFIG:class-native ??= "vulkan"
PACKAGECONFIG:class-target ??= "vulkan wayland samples"
...
EXTRA_OECMAKE_BUILD:class-native = "tools"
...
RPROVIDES:${PN}:append = " ${PN}-samples"

...
PACKAGECONFIG:class-native ??= "${@bb.utils.filter('DISTRO_FEATURES', 'vulkan wayland', d)}"
...
PACKAGECONFIG[samples] = "\
  -DFILAMENT_SKIP_SAMPLES=OFF -DFILAMENT_SKIP_SDL2=ON, \
  -DFILAMENT_SKIP_SAMPLES=ON  -DFILAMENT_SKIP_SDL2=OFF \
